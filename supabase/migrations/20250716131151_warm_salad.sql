/*
  # COMPLETE BALANS PSIKOLOJI SYSTEM - FINAL COMPLETE VERSION
...
'Bireysel terapi, kişinin yaşadığı psikolojik zorlukları aşmasına yardımcı olan, bire bir gerçekleştirilen profesyonel bir süreçtir.',
...
'Çift terapisi, partnerler arasındaki iletişim sorunlarını çözmek, ilişkiyi güçlendirmek ve sağlıklı bir birliktelik oluşturmak amacıyla yapılan profesyonel bir terapi sürecidir.',
...
'Aile içi çatışmaları çözmek ve sağlıklı aile dinamikleri oluşturmak için kapsamlı danışmanlık hizmetleri.',
...
'Çocuk ve ergenlerin gelişimsel süreçlerinde karşılaştıkları zorluklara yönelik uzman psikolojik destek.',
...
'Türkiye''nin her yerinden erişilebilir online terapi hizmetleri. Güvenli ve etkili dijital terapi seansları.',
...
'<h2>Kaygı Nedir?</h2><p>Kaygı, gelecekteki belirsizlikler karşısında yaşadığımız doğal bir duygudur...</p>',
...
'<h2>Çocuklarda Sosyal Kaygı Nedir?</h2><p>Sosyal kaygı, çocuğun sosyal ortamlarda yargılanacağı korkusu yaşaması...</p>',
...
'<h2>İletişimin Önemi</h2><p>Sağlıklı ilişkilerin temeli etkili iletişimdir...</p>',
